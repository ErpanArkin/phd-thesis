...
In addition to the basic properties of these materials that can be obtained by a single step DFT calculation, this thesis increases the level of the characterization by introducing additional approximations on top of the DFT calculations. This usually requires several calculations to be done under different conditions, e.g. mechanical strains, to find the relation between these results. By doing so, the properties related to more dynamical processes of the materials can be understood.
