...
\documentclass[a4paper,12pt,customfont,custombib,custommargin,online]{Classes/PhDThesisPSnPDF}
...
\printbibliography[notkeyword=own,notkeyword=rev,heading=bibintoc, title={References}]
...
%
%%first run without option prefixnumbers={P}, then add them in each bibliography and rerun.
\makeatletter
\begingroup
