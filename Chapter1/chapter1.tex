...
\caption[Graphite fluoride to fluorographene]{Graphite fluoride to fluorographene. Image source:\cite{Zhu2013}}  
\label{fig:gra_f}
\end{figure} 
...
\caption[Layered hexagonal structures of h-BN]{Layered hexagonal crystal structures of h-BN. Image adapted from:\cite{Benjah2007}}  
\label{fig:BN}
\end{figure} 
...
\caption[Band structure evolution of MoS$_2$ from bulk to single layer]{Band structure evolution of MoS$_2$ from bulk to single layer. Image source: \cite{Chhowalla2013}}  
...
\caption[Chiral vector and different type of nanotubes as obtained by rolling them up in different directions]{Chiral vector and different types of nanotubes as obtained by rolling them up in different directions. Image adapted from \cite{Prasek2011}}  
\label{fig:chiral}
\end{figure} 
...
\caption[Graphene production setups]{Graphene production setups. Image source \cite{Ferrari2015}}  
\label{fig:syn}
\end{figure} 
...
\caption[The growth of graphene on SiC wafer]{The growth of graphene on SiC wafer. Image source \cite{Mishra2016}}  
\label{fig:sic}
\end{figure} 
...
\caption[An ultra-large-area graphene film]{An ultra-large-area graphene film. Image source \cite{Bae2010}}  
\label{fig:30gr}
\end{figure} 
